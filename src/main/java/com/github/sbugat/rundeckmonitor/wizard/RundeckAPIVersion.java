...
public enum RundeckAPIVersion {
	...
	RUNDECK_APIVERSION_6( Version.V6, "1.4.4" ), //$NON-NLS-1$
	RUNDECK_APIVERSION_7( Version.V7, "1.4.4" ), //$NON-NLS-1$
	RUNDECK_APIVERSION_8( Version.V8, "1.4.4" ), //$NON-NLS-1$
	RUNDECK_APIVERSION_9( Version.V9, "1.4.4" ), //$NON-NLS-1$
	RUNDECK_APIVERSION_10( Version.V10, "1.4.4" ), //$NON-NLS-1$
	RUNDECK_APIVERSION_11( Version.V11, "1.4.4" ); //$NON-NLS-1$
	...
	public String toString() {
		return version + " - " + sinceRundeckVersion; //$NON-NLS-1$
	}
}
